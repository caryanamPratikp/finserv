  ...
  const liveUpdates = [
    {
      ...
      description:
        "Rahul Sharma submitted a new loan application.",
      color:
                ...
                <div className="mt-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {[
                      ...
                      <div
                        key={index}
                        className="bg-[#F4F6F9] rounded-2xl p-5 flex items-center justify-between"
                      >
                        <div>
                        ...
                        <button className="bg-[#27D3C3] hover:bg-[#1fb5a7] text-[#0B2A4A] px-4 py-2 rounded-xl font-medium transition">
                          View
                        </button>
                      </div>
                    ))}
