    ...
    <div className="bg-white rounded-3xl p-8 w-full max-w-md relative">
      ...
      <div className="space-y-5">
        <div>
          ...
          <input type="text" value={phoneForm.currentPhone} readOnly className="w-full bg-[#F8FAFC] border border-gray-200 rounded-2xl px-5 py-4" />
        </div>
        <div>
      ...
      <div className="flex gap-4 mt-8">
        <button onClick={() => { setProfileData({ ...profileData, phone: phoneForm.newPhone }); setPhoneForm({ currentPhone: phoneForm.newPhone, newPhone: "", otp: "" }); setShowPhoneModal(false); }} className="flex-1 bg-[#0B2A4A] text-white py-3 rounded-2xl font-semibold">Submit</button>
      </div>
    </div>
  </div>
)}
    ...
    <div className="bg-white rounded-3xl p-8 w-full max-w-md relative">
      ...
      <div className="space-y-5">
        <div>
          ...
          <input type="email" value={emailForm.currentEmail} readOnly className="w-full bg-[#F8FAFC] border border-gray-200 rounded-2xl px-5 py-4" />
        </div>
        <div>
      ...
      <div className="flex gap-4 mt-8">
        <button onClick={() => { setProfileData({ ...profileData, email: emailForm.newEmail }); setEmailForm({ currentEmail: emailForm.newEmail, newEmail: "", otp: "" }); setShowEmailModal(false); }} className="flex-1 bg-[#0B2A4A] text-white py-3 rounded-2xl font-semibold">Submit</button>
      </div>
    </div>
  </div>
)}
